...
# EarthInBeatsPlayer
•	Media player with social media elements for the Microsoft Store, featuring a graphical interface and user interaction based on a 3D Earth model.<br>
Developed using C++/WinRT and C# UWP, leveraging Media Foundation, XAudio2, and DirectX12.<br>
...
# Building
1. First run build_assimp.bat script
2. Then open and build EarthInBeatsPlayer.sln solution

TODO: fix model loading/add transfor matrix
